...
const AnimatedFeedPNG: React.FC = () => {
  return (
    <motion.div 
    ...
    >
      ...
      >
        <div className="text-lg font-medium text-gray-800">Track your feed!</div>
      </motion.div>

      {/* Info Badge */}
      <motion.div 
        className="absolute top-14 right-4 bg-green-500 text-white px-3 py-1 rounded-full text-sm font-medium shadow-md"
...
export default AnimatedFeedPNG;
