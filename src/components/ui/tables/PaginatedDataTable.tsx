...
const Pagination: React.FC<PaginationProps> = ({ 
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1a1a1a] px-4 py-3 sm:px-6">
...
export const PaginatedDataTable = <T = Record<string, unknown>>({
  data,
  columns,
  loading = false,
  ...
  return (
    <div className={`bg-white dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden ${className}`}>
      <DataTable
        data={paginatedData}
        columns={columns}
        loading={loading}
