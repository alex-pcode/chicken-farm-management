    ...
    return (
      <div className={`space-y-6 ${className}`}>
        ...
        <SectionContainer
          ...
          variant="glass"
        >
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Loading Batches...</h3>
          <GridContainer columns={{ md: 2, lg: 3 }} gap="sm">
            {[...Array(3)].map((_, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-blue-200 dark:border-blue-700 animate-pulse">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-3 mb-4">
              <h4 className="font-semibold text-blue-900 dark:text-blue-100 text-sm mb-1">🔧 Setup Required:</h4>
        ...
        <div className="neu-form">
          ...
          {batchLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400">No batches yet. Add your first batch to get started!</p>
              <Link
                to="/app/flock-batches"
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Active Batches</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {flockSummary.batchSummary.slice(0, 6).map((batch) => (
                    <div key={batch.id} className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-blue-200 dark:border-blue-700">
                      <div className="flex items-center gap-2 mb-2">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">{batch.breed}</p>
      ...
      >
        <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-1">Upgrade to Batch Management</h4>
