  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 space-y-8 lg:mt-0 lg:mb-[10%] lg:mx-[10%]" style={{ marginTop: '0' }}>
        ...
        >
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">Starting Investment</h2>
        ...
        <motion.div
          ...
          className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 lg:p-8"
        >
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">Setup Parameters</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="birdCount">
                Number of Chickens
              </label>
              <input
                id="birdCount"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="eggPrice">
                Price per Egg ($)
              </label>
              <input
                id="eggPrice"
        ...
        <motion.div
          ...
          className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 lg:p-8"
        >
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">Acquisition Method</h2>
              ...
              >
                <div className="text-center mb-4">
                  ...
                  {option.layingDelayMonths > 0 && (
                    <div className="inline-block px-3 py-1 rounded-full bg-orange-100 text-orange-600 text-xs font-medium mb-3">
        ...
        <motion.div
          ...
          className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 lg:p-8"
        >
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">Feeding Approach</h2>
        ...
        <motion.div
          ...
          className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 lg:p-8"
        >
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">Egg Production Scenario</h2>
        ...
        <AnimatePresence mode="wait">
          {showResults && (
            <motion.div
              ...
              className="bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-200 rounded-xl shadow-lg p-6 lg:p-8"
            >
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">Your Cost Analysis</h2>
              ...
              {results.layingDelayMonths > 0 && (
                <div className="mb-8 p-6 bg-orange-50 rounded-lg border border-orange-200">
                  <div className="flex items-start gap-3">
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-3">Baby Chick Timeline Impact</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-lg p-6 border border-gray-200">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-gray-600">First Year Feed Cost:</span>
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600">First Year Egg Value:</span>
                      <span className="font-semibold">
                    ...
                    {results.layingDelayMonths > 0 && (
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">• Non-laying months:</span>
                    ...
                    <div className="flex justify-between border-t pt-2">
                      <span className="font-semibold text-gray-900">First Year Profit:</span>
                ...
                <div className="bg-white rounded-lg p-6 border border-gray-200">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600">Monthly Profit (when laying):</span>
                      <span className={`font-semibold ${
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-200 rounded-xl shadow-lg p-6 lg:p-8"
        >
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">💡 Cost Assessment</h2>
          
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6">
              <h4 className="font-semibold text-gray-900 mb-2">Break-Even Analysis</h4>
            ...
            <div className="bg-white rounded-lg p-6">
              <h4 className="font-semibold text-gray-900 mb-2">Your Assessment</h4>
              <p className="text-gray-700">
                {results.monthlyProfit > 0 
