...
const AnimatedCRMPNG: React.FC = () => {
  return (
    ...
    >
      ...
      >
        <div className="text-lg font-medium text-gray-800">Manage your customers!</div>
      </motion.div>

      {/* Info Badge */}
      <motion.div 
        className="absolute top-14 right-4 bg-blue-500 text-white px-3 py-1 rounded-full text-sm font-medium shadow-md"
